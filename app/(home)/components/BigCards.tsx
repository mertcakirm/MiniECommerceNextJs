        ...
        <div className="container flex flex-col items-center justify-center gap-6 py-5 mx-auto">
            <div className="flex flex-col md:flex-row justify-center gap-6 w-full">
                {cards.slice(0, 2).map((card) => (
                    <Link
                        href={`/products/category/${card.title.replace(/\s+/g, "-").toLowerCase()}`}
                        key={card.id}
                    ...
                    >
                        ...
                        />
                        <div
                            className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-6 w-full">
                {cards.slice(2).map((card) => (
                    <Link
                        href={`/products/category/${card.title.replace(/\s+/g, "-")}`}
                        key={card.id}
